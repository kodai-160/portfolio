          ...
          <div className="prose dark:prose-invert prose-lg max-w-none markdown-content">
            <ReactMarkdown 
              ...
              components={{
                ...
                h3: ({node, ...props}) => <h3 className="text-lg font-bold mt-4 mb-2 text-gray-900 dark:text-gray-100" {...props} />,
                p: ({node, ...props}) => <p className="mb-4 leading-relaxed text-gray-800 dark:text-gray-200" {...props} />,
                ul: ({node, ...props}) => <ul className="list-disc pl-6 mb-4 text-gray-800 dark:text-gray-200" {...props} />,
                ol: ({node, ...props}) => <ol className="list-decimal pl-6 mb-4 text-gray-800 dark:text-gray-200" {...props} />,
                ...
                blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-blue-300 dark:border-blue-700 pl-4 italic mb-4 text-gray-700 dark:text-gray-300" {...props} />,
              }}
            >
              {post.content}
            </ReactMarkdown>
